 ...
 * @author JoseM
 */
public class AdminGrado extends javax.swing.JFrame {

    /**
     * Creates new form AdminGrado
     */
    public AdminGrado() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jfechaNac.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.DateFormatter(new java.text.SimpleDateFormat("dd-MM-yyyy"))));

        jLabel4.setText("Alumno:");

        jLabel5.setText("Grupo:");

        btnCrear.setText("Crear Grado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminGrado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminGrado().setVisible(true);
            }
        });
    }
