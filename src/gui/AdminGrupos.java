 ...
 */
public final class AdminGrupos extends javax.swing.JFrame {
    ...
    public void CargarComboBox() throws ClassNotFoundException{
        ...
        grados.forEach((grado) -> {
            cbGrado.addItem(new ComboItem(grado[1]+" "+grado[2],grado[0].toString()));
        });
    }
    ...
    public void CargaAutomatica() throws ClassNotFoundException{
        ...
        if(modelo.getColumnCount() <= 0){
            ...
            columnas.add("ID");
            columnas.add("Nombre");
            columnas.add("Grado al que pertenece");
        ...
        ArrayList<Object[]> grupos = GrupoHandler.selectGrupo();
        
        grupos.forEach((grupo) -> {
            modelo.addRow(grupo);
        });
        tablaGrupos.setModel(modelo);
        this.txtregistros.setText(grupos.size()+"");
        ...
        tablaGrupos.getSelectionModel().addListSelectionListener(new ListSelectionListener(){
            ...
            public void valueChanged(ListSelectionEvent event) {
                ...
                if (!event.getValueIsAdjusting() &&tablaGrupos.getSelectedRow() != -1){
                    txtID.setText(tablaGrupos.getValueAt(tablaGrupos.getSelectedRow(),0).toString());
                    txtNombre.setText(tablaGrupos.getValueAt(tablaGrupos.getSelectedRow(),1).toString());
                    //txtSeccion.setText(tablaGrupos.getValueAt(tablaGrupos.getSelectedRow(),2).toString());
     ...
     */
    public AdminGrupos() throws ClassNotFoundException {
        initComponents();
        CargaAutomatica();
        CargarComboBox();
    }
    ...
    private void initComponents() {
        ...
        cbGrado = new javax.swing.JComboBox<ComboItem>();
        ...
        jLabel4.setText("Administración de Grupos");
        ...
        jLabel7.setText("Grado al que pertenece:");

        btnActualizar.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        btnActualizar.setText("Actualizar Grupo");
        btnActualizar.setEnabled(false);
        ...
        btnAnadir.setText("Añadir Grupo");
        ...
        cbGrado.setFont(new java.awt.Font("Tahoma", 0, 14));
    ...
    private void btnAnadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnadirActionPerformed
        ...
        if(!txtNombre.getText().trim().equals("") && cbGrado.getSelectedIndex() != -1){
            Grupo nuevo = new Grupo();
            nuevo.setNombre(txtNombre.getText().trim());
            Object item = cbGrado.getSelectedItem();
            nuevo.setIdGrado(Integer.parseInt(((ComboItem)item).getValue()));
            try {
                boolean insercion = GrupoHandler.insertGrupo(nuevo);
                if(insercion){
                    JOptionPane.showMessageDialog(null,"Grupo insertado Correctamente","Correcto",JOptionPane.INFORMATION_MESSAGE);
                    CargaAutomatica();
                    RestablecerCampos();
                }else{
                ...
                Logger.getLogger(AdminGrupos.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else{
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if(!txtNombre.getText().trim().equals("") && cbGrado.getSelectedIndex() != -1){
            ...
            try {
                boolean actualizacion = GrupoHandler.updateGrupo(actualizar);
                if(actualizacion){
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if(dialogResult == JOptionPane.YES_OPTION){
          boolean eliminacion;
            try {
                eliminacion = GrupoHandler.deleteGrupo(Integer.parseInt(txtID.getText().trim()));
                if(eliminacion){
    ...
    private javax.swing.JComboBox<ComboItem> cbGrado;
